...
This costs less than it sounds *here* — the mission needs 8 Mbps and even a single stream clears it by an order of magnitude — but it is worth knowing you are buying it, and worth checking before anyone concludes the link is underperforming on the bench. The fixes, in order of preference:
