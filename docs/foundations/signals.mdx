...
- **What it costs** prices the build per side at the quantity it really needs, and quotes **dollars per dB of link margin**. That number is the argument on this page reduced to one figure.
