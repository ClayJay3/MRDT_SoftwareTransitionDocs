...
There's one rule above all of it. The hard facts here, like the IPs, ports, packet IDs, and file paths, came straight out of the repos rather than from memory, so if a repo and this site ever disagree, trust the repo.
